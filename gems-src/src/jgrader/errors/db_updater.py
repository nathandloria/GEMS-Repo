...
filepath = r'/home/lorian/Desktop/GEMS/GEMS-Repo/gems-src/src/jgrader/errors/enhancederrors.txt'
...
filepath = r'/home/lorian/Desktop/GEMS/GEMS-Repo/gems-src/src/jgrader/errors/ogerrors.txt'
with open(filepath) as fp:
    ecnt = 0
    i = 0
    for line in fp:
